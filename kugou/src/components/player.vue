<template>
	<div class="audio-view" :class="{'audio_panel_hide':toggleHide}">
		...
		<div class="audio-panel">
			<img :src="audio.imgUrl" @click='showDetailPlayer()' class="player-img">
			<div class="player-status" @click='showDetailPlayer()'>
				<p class="player-title ellipsis">
					{{audio.title}}
				</p>
				<p class="player-singer ellipsis">
					{{audio.singer}}
				</p>
			</div>
			<div class="player-controls">
				<span class="player-Play" @click='toggleStatus()' :class="{'player-Pause':isPlay}">
				</span>
