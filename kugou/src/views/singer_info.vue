<template>
	<div class="rank-info-content plist-info">
		...
		<div class="plist-desp container">
			...
			<img src="../assets/images/close_icon.png" alt="" class="plist-desp-icon" @click="toggleDesp" v-if="hideDesp">
			<img src="../assets/images/open_icon.png" alt="" class="plist-desp-icon" @click="toggleDesp" v-else>
		</div>
		<div class="plist-desp-bottom" style="width:100%;height:5px;background-color:#f1f1f1"></div>
		<div class="rank-info-list">
			<mt-cell v-for="(item,index) in snogList" :title="item.title" @click.native="playAudio(index)">
